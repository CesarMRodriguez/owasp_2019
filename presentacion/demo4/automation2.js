//frida -U --no-pause -l demo4/automation2.js com.example.ritesh.mybasiccalculator_riteshbhat
	...
	Java.registerClass({
	   ...
	   methods: {
	       'run': function() {
			   ...
			   if (text == expected) {
			   		console.log("[+] test "+int1+" "+ operation +" "+int2 + " exitoso");
			   } else {
			   		console.error("[-] test "+int1+" "+ operation +" "+int2 + " retorno " + text + " y esperaba " + expected);
			   }
